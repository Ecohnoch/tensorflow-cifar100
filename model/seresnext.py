...
def se_resnext50(input_tensor, is_training, reuse, cardinality, kernel_initializer=None):
	return get_resnet(input_tensor, [3,4,6,3], is_training, reuse, cardinality, kernel_initializer)

def se_resnext110(input_tensor, is_training, reuse, cardinality, kernel_initializer=None):
	return get_resnet(input_tensor, [3,4,23,3], is_training, reuse, cardinality, kernel_initializer)

def se_resnext152(input_tensor, is_training, reuse, cardinality, kernel_initializer=None):
